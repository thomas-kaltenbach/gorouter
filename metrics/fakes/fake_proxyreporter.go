...
type FakeProxyReporter struct {
	...
	CaptureDeprecatedResponseStub        func()
	captureDeprecatedResponseMutex       sync.RWMutex
	captureDeprecatedResponseArgsForCall []struct {
	}
...
func (fake *FakeProxyReporter) CaptureDeprecatedResponse() {
	fake.captureDeprecatedResponseMutex.Lock()
	fake.captureDeprecatedResponseArgsForCall = append(fake.captureDeprecatedResponseArgsForCall, struct {
	}{})
	stub := fake.CaptureDeprecatedResponseStub
	fake.recordInvocation("CaptureDeprecatedResponse", []interface{}{})
	fake.captureDeprecatedResponseMutex.Unlock()
	if stub != nil {
		fake.CaptureDeprecatedResponseStub()
	}
}

func (fake *FakeProxyReporter) CaptureDeprecatedResponseCallCount() int {
	fake.captureDeprecatedResponseMutex.RLock()
	defer fake.captureDeprecatedResponseMutex.RUnlock()
	return len(fake.captureDeprecatedResponseArgsForCall)
}

func (fake *FakeProxyReporter) CaptureDeprecatedResponseCalls(stub func()) {
	fake.captureDeprecatedResponseMutex.Lock()
	defer fake.captureDeprecatedResponseMutex.Unlock()
	fake.CaptureDeprecatedResponseStub = stub
}
