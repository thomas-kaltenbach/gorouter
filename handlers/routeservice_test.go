...
var _ = Describe("Route Service Handler", func() {
	...
	BeforeEach(func() {
		...
		testReq := test_util.NewRequest("GET", "my_host.com", "/resource+9-9_9?query=dog%20cat&query$2=345#page1..5", body)
		forwardedUrl = "https://my_host.com/resource+9-9_9?query=dog%20cat&query$2=345#page1..5"
